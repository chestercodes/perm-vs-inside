// https://github.com/mveith/CzechElection/blob/master/src/Fable.Import.Chartjs.fs
...
[<Global>]
type private Chart(ctx:Browser.Types.HTMLElement, settings:obj) =
...
let renderChart chart=
    let ctx = Browser.Dom.document.getElementById chart.CanvasId
